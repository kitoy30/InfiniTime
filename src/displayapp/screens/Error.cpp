...
Error::Error(System::BootErrors error) {
  ...
  lv_label_set_text_static(warningLabel, "Attention");
  ...
  if (error == System::BootErrors::TouchController) {
    lv_label_set_text_static(causeLabel, "Erreur de l'écran tactile.");
  }
  ...
  lv_label_set_text_static(tipLabel, "Si vous rencontrez un problème et que votre appareil est sous garantie, contactez votre revendeur.");
  ...
  lv_label_set_text_static(lblOk, "Procéder");
