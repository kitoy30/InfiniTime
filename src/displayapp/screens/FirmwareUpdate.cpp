...
FirmwareUpdate::FirmwareUpdate(const Pinetime::Controllers::Ble& bleController) : bleController {bleController} {
  ...
  lv_label_set_text_static(titleLabel, "MAJ du micrologiciel");
  ...
  lv_label_set_text_static(percentLabel, "Patientez...");
...
void FirmwareUpdate::UpdateError() {
  lv_label_set_text_static(percentLabel, "#ff0000 Erreur!#");
  startTime = xTaskGetTickCount();
}
